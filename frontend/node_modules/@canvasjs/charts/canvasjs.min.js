/* 
 CanvasJS Chart - v3.12.16 GA - https://canvasjs.com/ 
...
function(d){if(0!==this.fontSize){d&&this.ctx.save();var p=this.ctx.font;this.ctx.textBaseline=this.textBaseline;var u=0;this._isDirty&&this.measureText(this.ctx);this.ctx.translate(this.x,this.y+u);"middle"===this.textBaseline&&(u=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var t=0,C=this.topPadding,D=null;this.ctx.roundRect||xa(this.ctx);this.borderDashType=this.borderDashType||"solid";this.ctx.setLineDash&&this.ctx.setLineDash(J(this.borderDashType,
...
function(){var d=new String(Fa(String(this.text))),p=[],u=this.ctx.font,t=0,C=0;this.ctx.font=this._getFontString();if(0===this.frontSize)C=t=0;else for(;0<d.length;){var D=this.maxHeight-(this.topPadding+this.bottomPadding),A=this._getLineWithWidth(d,this.maxWidth-(this.leftPadding+this.rightPadding),!1);A.height=this._lineHeight;p.push(A);var J=C,C=Math.max(C,A.width),t=t+A.height,d=Fa(d.slice(A.text.length,d.length));D&&t>D&&(A=p.pop(),t-=A.height,C=J)}this._wrappedText={lines:p,width:C,height:t};
this.width=C+(this.leftPadding+this.rightPadding);this.height=t+(this.topPadding+this.bottomPadding);this.ctx.font=u};ja.prototype._getFontString=function(){var d;d=""+(this.fontStyle?this.fontStyle+" ":"");d+=this.fontWeight?this.fontWeight+" ":"";d+=this.fontSize?this.fontSize+"px ":"";var p=this.fontFamily?this.fontFamily+"":"";!u&&p&&(p=p.split(",")[0],"'"!==p[0]&&'"'!==p[0]&&(p="'"+p+"'"));return d+=p};pa(Ua,U);pa(ya,U);ya.prototype.setLayout=function(){if(this.text){var d=this.dockInsidePlotArea?
...
fontStyle:this.fontStyle,fontWeight:this.fontWeight,textAlign:this.textAlign,verticalAlign:this.verticalAlign,borderColor:this.borderColor,borderThickness:this.borderThickness,backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:t,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"middle"}),J=A.measureText();"center"===this.verticalAlign?("left"===this.horizontalAlign?(u=l.x1+2+A._lineHeight/2,t=l.y2-2-(this.maxWidth/2-J.width/2),C=-90,D="left",this.width=
J.height,this.height=J.width):"right"===this.horizontalAlign?(u=l.x2-2-A._lineHeight/2,t=l.y1+2+(this.maxWidth/2-J.width/2),C=90,D="right",this.width=J.height,this.height=J.width):(t=l.y1+2+(l.height/2-J.height/2)+A._lineHeight/2,u=l.x1+2+(l.width/2-J.width/2),D="center",this.width=J.width,this.height=J.height),l="center"):("bottom"===this.verticalAlign?(t=l.y2-2-J.height+A._lineHeight/2,D="bottom"):(t=l.y1+2+A._lineHeight/2,D="top"),u="left"===this.horizontalAlign?l.x1+2:"right"===this.horizontalAlign?
l.x2-2-J.width-u:l.x1+l.width/2-J.width/2,l=this.horizontalAlign,this.width=J.width,this.height=J.height);A.x=u;A.y=t;A.angle=C;A.horizontalAlign=l;this._textBlock=A;d.layoutManager.registerSpace(D,{width:this.width+("left"===D||"right"===D?this.margin+2:0),height:this.height+("top"===D||"bottom"===D?this.margin+2:0)});this.bounds={x1:u,y1:t-A._lineHeight/2,x2:u+this.width,y2:t+this.height-A._lineHeight/2};"center"===this.verticalAlign&&("left"===this.horizontalAlign&&(this.bounds={x1:u-A._lineHeight/
2,y1:t-this.height,x2:u+this.width-A._lineHeight/2,y2:t}),"right"===this.horizontalAlign&&(this.bounds={x1:u-A._lineHeight/2,y1:t,x2:u+this.width-A._lineHeight/2,y2:t+this.height}));this.ctx.textBaseline="top"}};ya.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};pa(Ha,U);Ha.prototype.setLayout=ya.prototype.setLayout;Ha.prototype.render=ya.prototype.render;Va.prototype.get=function(d,p){var u=null;0<this.pool.length?(u=this.pool.pop(),La(u,d,p)):u=ta(d,p);return u};Va.prototype.release=
function(d){this.pool.push(d)};pa(Ia,U);var Pa={addTheme:function(d,p){Na[d]=p},addColorSet:function(d,p){za[d]=p},addCultureInfo:function(d,p){Ja[d]=p},formatNumber:function(d,p,u){u=u||"en";if(Ja[u])return ca(d,p||"#,##0.##",new Ia(u));throw"Unknown Culture Name";},formatDate:function(d,p,u){u=u||"en";if(Ja[u])return Aa(d,p||"DD MMM YYYY",new Ia(u));throw"Unknown Culture Name";}};"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=Pa:"function"===typeof define&&define.amd?
define([],function(){return Pa}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?window.CanvasJS:Pa);t=Pa.Chart=function(){function d(a,g){return a.x-g.x}function l(a,g,b){g=g||{};p(b)?(this.predefinedThemes=Na,this.optionsName=this.parent=this.index=null):(this.parent=b.parent,this.index=b.index,this.predefinedThemes=
...
0;this.disableToolTip=this.animatedRender=!1;this.canvasPool=new Va;this.allDOMEventHandlers=[];this.panEnabled=!1;this._defaultCursor="default";this.plotArea={canvas:null,ctx:null,x1:0,y1:0,x2:0,y2:0,width:0,height:0};this._dataInRenderedOrder=[];(this.container="string"===typeof this._containerId?document.getElementById(this._containerId):this._containerId)?(this.container.innerHTML="",g=a=0,g=bb(this.container),a=this.options.width?this.width:0<this.container.clientWidth-parseFloat(g.paddingLeft)-
parseFloat(g.paddingRight)?this.container.clientWidth-parseFloat(g.paddingLeft)-parseFloat(g.paddingRight):this.width,g=b&&b.height?b.height:this.options.height?this.height:0<this.container.clientHeight-parseFloat(g.paddingTop)-parseFloat(g.paddingBottom)?this.container.clientHeight-parseFloat(g.paddingTop)-parseFloat(g.paddingBottom):this.height,this.width=a,this.height=g,this.x1=this.y1=0,this.x2=this.width,this.y2=this.height,this.selectedColorSet="undefined"!==typeof za[this.colorSet]?za[this.colorSet]:
za.colorSet1,this._canvasJSContainer=document.createElement("div"),this._canvasJSContainer.setAttribute("class","canvasjs-chart-container"),this._canvasJSContainer.style.position="relative",this._canvasJSContainer.style.textAlign="left",this._canvasJSContainer.style.cursor="auto",this._canvasJSContainer.style.direction="ltr",u||(this._canvasJSContainer.style.height="0px"),this.container.appendChild(this._canvasJSContainer),this.canvas=ta(a,g),this._preRenderCanvas=ta(a,g),this.canvas.style.position=
"absolute",this.canvas.style.WebkitUserSelect="none",this.canvas.style.MozUserSelect="none",this.canvas.style.msUserSelect="none",this.canvas.style.userSelect="none",this.canvas.getContext&&(this._canvasJSContainer.appendChild(this.canvas),this.ctx=this.canvas.getContext("2d"),this.ctx.textBaseline="top",xa(this.ctx),this._preRenderCtx=this._preRenderCanvas.getContext("2d"),this._preRenderCtx.textBaseline="top",xa(this._preRenderCtx),u?this.plotArea.ctx=this.ctx:(this.plotArea.canvas=ta(a,g),this.plotArea.canvas.style.position=
...
"none",this.overlaidCanvas.getContext&&(this._canvasJSContainer.appendChild(this.overlaidCanvas),this.overlaidCanvasCtx=this.overlaidCanvas.getContext("2d"),this.overlaidCanvasCtx.textBaseline="top",xa(this.overlaidCanvasCtx)),this._eventManager=new V(this),this.windowResizeHandler=O(window,"resize",function(){c._updateSize()&&(c.render(),c.isNavigator&&(c.stockChart&&c.stockChart.navigator&&c.stockChart.navigator.enabled)&&c.stockChart.navigator._updateSlider(c.stockChart._axisXMin,c.stockChart._axisXMax))},
this.allDOMEventHandlers),this._toolBar=document.createElement("div"),this._toolBar.setAttribute("class","canvasjs-chart-toolbar"),L(this._toolBar,{position:"absolute",right:"1px",top:"1px"}),this._canvasJSContainer.appendChild(this._toolBar),this.bounds={x1:0,y1:0,x2:this.width,y2:this.height},O(this.overlaidCanvas,"click",function(a){c._mouseEventHandler(a)},this.allDOMEventHandlers),O(this.overlaidCanvas,"mousemove",function(a){c._mouseEventHandler(a)},this.allDOMEventHandlers),O(this.overlaidCanvas,
"mouseup",function(a){c._mouseEventHandler(a)},this.allDOMEventHandlers),O(this.overlaidCanvas,"mousedown",function(a){c._mouseEventHandler(a);va(c._dropdownMenu)},this.allDOMEventHandlers),O(this.overlaidCanvas,"mouseout",function(a){c._mouseEventHandler(a)},this.allDOMEventHandlers),O(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerDown":"touchstart",function(a){c._touchEventHandler(a)},this.allDOMEventHandlers),O(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerMove":
...
{axisX:[],axisX2:[],axisY:[],axisY2:[]})):window.console&&window.console.log('CanvasJS Error: Chart Container with id "'+this._containerId+'" was not found')}function t(a,g){for(var b=[],c,e=0;e<a.length;e++)if(0==e)b.push(a[0]);else{var h,r,y;y=e-1;h=0===y?0:y-1;r=y===a.length-1?y:y+1;c=Math.abs((a[r].x-a[h].x)/(0===a[r].x-a[y].x?0.01:a[r].x-a[y].x))*(g-1)/2+1;var I=(a[r].x-a[h].x)/c;c=(a[r].y-a[h].y)/c;b[b.length]=a[y].x>a[h].x&&0<I||a[y].x<a[h].x&&0>I?{x:a[y].x+I/3,y:a[y].y+c/3}:{x:a[y].x,y:a[y].y+
(1===b.length?0:c/9)};y=e;h=0===y?0:y-1;r=y===a.length-1?y:y+1;c=Math.abs((a[r].x-a[h].x)/(0===a[y].x-a[h].x?0.01:a[y].x-a[h].x))*(g-1)/2+1;I=(a[r].x-a[h].x)/c;c=(a[r].y-a[h].y)/c;b[b.length]=a[y].x>a[h].x&&0<I||a[y].x<a[h].x&&0>I?{x:a[y].x-I/3,y:a[y].y-c/3}:{x:a[y].x,y:a[y].y-c/9};b[b.length]=a[e]}return b}function C(a,g,b,c,e,h,r,y,I,k){var m=0;k?(r.color=h,y.color=h):k=1;m=I?Math.abs(e-b):Math.abs(c-g);m=0<r.trimLength?Math.abs(m*r.trimLength/100):Math.abs(m-r.length);I?(b+=m/2,e-=m/2):(g+=m/2,
...
r.thickness||2;a.setLineDash&&a.setLineDash(J(r.dashType,r.thickness));a.beginPath();I&&0<r.thickness?(a.moveTo(c-m,b),a.lineTo(c-m,e),a.moveTo(g+m,b),a.lineTo(g+m,e)):0<r.thickness&&(a.moveTo(g,b+m),a.lineTo(c,b+m),a.moveTo(g,e-m),a.lineTo(c,e-m));a.stroke();a.restore()}function D(a,g){D.base.constructor.call(this,"Legend","legend",g,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.ghostCtx=this.chart._eventManager.ghostCtx;this.items=[];this.optionsName="legend";this.height=
this.width=0;this.orientation=null;this.dataSeries=[];this.bounds={x1:null,y1:null,x2:null,y2:null};"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.lineHeight=Ya(this.fontFamily,this.fontSize,this.fontWeight);this.horizontalSpacing=this.fontSize}function P(a,g,b,c){P.base.constructor.call(this,"DataSeries","data",g,b,a);this.chart=a;this.canvas=a.canvas;this._ctx=a.canvas.ctx;this.index=b;this.noDataPointsInPlotArea=0;this.id=c;this.chart._eventManager.objectMap[c]=
...
{x1:null,y1:null,x2:null,y2:null,width:null};this.labelAngle=(this.labelAngle%360+360)%360;90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360);this.options.scaleBreaks&&(this.scaleBreaks=new ha(this.chart,this.options.scaleBreaks,++this.chart._eventManager.lastObjectId,this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new ea(this.chart,
this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new fa(this.chart,this.options.crosshair,this),this.crosshair._updatedValue=p(this.sessionVariables.crosshairValue)?null:this.sessionVariables.crosshairValue);this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=void 0,this.sessionVariables.viewportMinimum=null);this.hasOptionChanged("viewportMinimum")||isNaN(this.sessionVariables.newViewportMinimum)||
...
this.label;this.axis=e;this.optionsName="stripLines";this.isOptionsInArray=!0;this._thicknessType="pixel";null!==this.startValue&&null!==this.endValue&&(this.value=e.logarithmic?Math.sqrt((this.startValue.getTime?this.startValue.getTime():this.startValue)*(this.endValue.getTime?this.endValue.getTime():this.endValue)):((this.startValue.getTime?this.startValue.getTime():this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function fa(a,g,b){fa.base.constructor.call(this,
"Crosshair","crosshair",g,null,b);this.chart=a;this.ctx=this.chart.ctx;this.axis=b;this.optionsName="crosshair";this._thicknessType="pixel"}function ma(a,g){ma.base.constructor.call(this,"ToolTip","toolTip",g,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName=
"toolTip";this._initialize()}function V(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=ta(this.chart.width,this.chart.height,!0);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function ka(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;this.animations=[];this.animationRequestId=null}pa(l,U);l.prototype.destroy=function(){var a=this.allDOMEventHandlers;this._animator&&
...
for(;this._dropdownMenu&&this._dropdownMenu.hasChildNodes();)this._dropdownMenu.removeChild(this._dropdownMenu.lastChild);this.container=this._canvasJSContainer=null;this.toolTip.container=null;this.canvas&&wa(this.canvas);this.overlaidCanvas&&wa(this.overlaidCanvas);this._preRenderCanvas&&wa(this._preRenderCanvas);this._breaksCanvas&&wa(this._breaksCanvas);this._eventManager&&this._eventManager.ghostCanvas&&wa(this._eventManager.ghostCanvas);this._toolBar=this._dropdownMenu=this._menuButton=this._resetButton=
...
this.stockChart.culture);this._cultureInfo=new Ia(this.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&u;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.toolbar=new Ua(this,this.options.toolbar);if(this.stockChart&&this.stockChart.options&&this.stockChart.options.toolbar&&!this.options.toolbar)for(var g in this.stockChart.options.toolbar)this.toolbar[g]=
this.stockChart.options.toolbar[g];if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)L(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&this._zoomButton.childNodes[0]&&L(this._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"});else{var b=!1;va(this._zoomButton=document.createElement("button"));
sa(this,this._zoomButton,"pan");this._toolBar.appendChild(this._zoomButton);this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor;O(this._zoomButton,"touchstart",function(a){b=!0},this.allDOMEventHandlers);O(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,sa(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,sa(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);O(this._zoomButton,"mousemove",
function(){b?b=!1:(L(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&L(a._zoomButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);O(this._zoomButton,"mouseout",function(){b||(L(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&
L(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton?(L(this._resetButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&this._resetButton.childNodes[0]&&L(this._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}),this._resetButton.title=this._cultureInfo.resetText):
(b=!1,va(this._resetButton=document.createElement("button")),sa(this,this._resetButton,"reset"),this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+this.toolbar.buttonBorderColor,this._toolBar.appendChild(this._resetButton),O(this._resetButton,"touchstart",function(a){b=!0},this.allDOMEventHandlers),O(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip&&a.toolTip.enabled&&a.toolTip.dispatchEvent("hidden",{chart:a,toolTip:a.toolTip},
...
null,a.sessionVariables.axisX2[c].newViewportMaximum=null;if(a.sessionVariables.axisY)for(c=0;c<a.sessionVariables.axisY.length;c++)a.sessionVariables.axisY[c].newViewportMinimum=null,a.sessionVariables.axisY[c].newViewportMaximum=null;if(a.sessionVariables.axisY2)for(c=0;c<a.sessionVariables.axisY2.length;c++)a.sessionVariables.axisY2[c].newViewportMinimum=null,a.sessionVariables.axisY2[c].newViewportMaximum=null;a.resetOverlayedCanvas();0>=navigator.userAgent.search("MSIE")&&L(a._resetButton.childNodes[0],
...
this.axisX2[0].gridThickness=0:0<this.axisX2[0].gridThickness&&"undefined"===typeof this.axisX[0].options.gridThickness&&(this.axisX[0].gridThickness=0));b=!1;if(0<this._axes.length&&this.options.zoomEnabled&&(this.zoomEnabled||this.panEnabled))for(g=0;g<this._axes.length;g++)if(!p(this._axes[g].viewportMinimum)||!p(this._axes[g].viewportMaximum)){b=!0;break}b?(Ka(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,
this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,this._resetButton.style.borderRight=(this.exportEnabled?this.toolbar.buttonBorderThickness:0)+"px solid "+this.toolbar.buttonBorderColor):(va(this._zoomButton,this._resetButton),this._toolBar.style.border=this.toolbar.buttonBorderThickness+"px solid transparent",this.options.zoomEnabled&&(this.zoomEnabled=!0,this.panEnabled=!1));gb(this);this._processData();this.options.title&&(this.title=
new ya(this,this.options.title),this.title.dockInsidePlotArea?a.push(this.title):this.title.setLayout());if(this.options.subtitles)for(g=0;g<this.options.subtitles.length;g++)b=new Ha(this,this.options.subtitles[g],g),this.subtitles.push(b),b.dockInsidePlotArea?a.push(b):b.setLayout();this.legend=new D(this,this.options.legend);for(g=0;g<this.data.length;g++)(this.data[g].showInLegend||"pie"===this.data[g].type||"doughnut"===this.data[g].type||"funnel"===this.data[g].type||"pyramid"===this.data[g].type)&&
...
y.type&&(I=this.renderBoxAndWhisker(y));for(var k=0;k<y.dataSeriesIndexes.length;k++)this._dataInRenderedOrder.push(this.data[y.dataSeriesIndexes[k]]);this.animatedRender&&(y.targetCanvasCtx.miterLimit=e,I&&b.push(I))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&b.push({source:this._breaksCanvasCtx,dest:this.plotArea.ctx,animationCallback:N.fadeInAnimation,easingFunction:N.easing.easeInQuad,animationBase:0,startTimePercent:0.7});this.animatedRender&&0<this._indexLabels.length&&
(e=ta(this.width,this.height).getContext("2d"),xa(e),b.push(this.renderIndexLabels(e)));var m=this;if(0<b.length)m.disableToolTip=!0,m._animator.animate(200,m.animationDuration,function(a){m.ctx.clearRect(0,0,m.width,m.height);m.ctx.drawImage(c,0,0,Math.floor(m.width*la),Math.floor(m.height*la),0,0,m.width,m.height);for(var e=0;e<b.length;e++)I=b[e],1>a&&"undefined"!==typeof I.startTimePercent?a>=I.startTimePercent&&I.animationCallback(I.easingFunction(a-I.startTimePercent,0,1,1-I.startTimePercent),
I):I.animationCallback(I.easingFunction(a,0,1,1),I);m.dispatchEvent("dataAnimationIterationEnd",{chart:m})},function(){b=[];for(var a=0;a<m.plotInfo.plotTypes.length;a++)for(var e=m.plotInfo.plotTypes[a],f=0;f<e.plotUnits.length;f++){var h=e.plotUnits[f];h.targetCanvas&&wa(h.targetCanvas);h.targetCanvas=null}c=null;m.disableToolTip=!1;m.dispatchEvent("dataAnimationEnd",{chart:m})});else{if(m._breaksCanvas)if(u)m.plotArea.ctx.drawImage(m._breaksCanvas,0,0,this.width,this.height);else for(k=0;k<m._axes.length;k++)m._axes[k].createMask();
0<m._indexLabels.length&&m.renderIndexLabels();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});m.dispatchEvent("dataAnimationEnd",{chart:m})}this.attachPlotAreaEventHandlers();this.zoomEnabled||(this.panEnabled||!this._zoomButton||"none"===this._zoomButton.style.display)||va(this._zoomButton,this._resetButton);p(this.toolTip._xValue)||p(this.toolTip._dataSeriesIndex)||this.toolTip.showAtX(this.toolTip._xValue,this.toolTip._dataSeriesIndex);this.toolTip._updateToolTip();this.toolTip.enabled&&
this.toolTip._updatedEventParameters&&!isNaN(this.toolTip._prevX)&&!isNaN(this.toolTip._prevY)&&this.toolTip.container&&this.toolTip.container.style&&this.toolTip.dispatchEvent("none"===this.toolTip.container.style.display?"hidden":"updated",this.toolTip._updatedEventParameters,this.toolTip);this.renderCount++;Ga&&(m=this,setTimeout(function(){var a=document.getElementById("ghostCanvasCopy");a&&(La(a,m.width,m.height),a.getContext("2d").drawImage(m._eventManager.ghostCanvas,0,0))},2E3));this._breaksCanvas&&
...
a.axisX.options.maximum:Infinity;if(y.dataPoints[I].x&&y.dataPoints[I].x.getTime||"dateTime"===y.xValueType)h=!0;for(I=0;I<y.dataPoints.length;I++){"undefined"===typeof y.dataPoints[I].x&&(y.dataPoints[I].x=I+(a.axisX.logarithmic?1:0));y.dataPoints[I].x.getTime?(h=!0,c=y.dataPoints[I].x.getTime()):c=y.dataPoints[I].x;e=y.dataPoints[I].y;c<b.min&&(b.min=c);c>b.max&&(b.max=c);e<g.min&&"number"===typeof e&&(g.min=e);e>g.max&&"number"===typeof e&&(g.max=e);if(0<I){if(a.axisX.logarithmic){var d=c/y.dataPoints[I-
1].x;1>d&&(d=1/d);b.minDiff>d&&1!==d&&(b.minDiff=d)}else d=c-y.dataPoints[I-1].x,0>d&&(d*=-1),b.minDiff>d&&0!==d&&(b.minDiff=d);null!==e&&null!==y.dataPoints[I-1].y&&(a.axisY.logarithmic?(d=e/y.dataPoints[I-1].y,1>d&&(d=1/d),g.minDiff>d&&1!==d&&(g.minDiff=d)):(d=e-y.dataPoints[I-1].y,0>d&&(d*=-1),g.minDiff>d&&0!==d&&(g.minDiff=d)))}if(c<q&&!k)null!==e&&(n=c);else{if(!k&&(k=!0,0<I)){I-=2;continue}if(c>f&&!m)m=!0;else if(c>f&&m)continue;y.dataPoints[I].label&&(a.axisX.labels[c]=y.dataPoints[I].label);
...
e?b.viewPortMin===c&&w<c&&(b.viewPortMin=w):(I[c]=(I[c]||0)+n.dataPoints[q].y,n.dataPointEOs[q].cumulativeY=I[c],a.yTotals[c]=(a.yTotals[c]?a.yTotals[c]:0)+e,a.yAbsTotals[c]=(a.yAbsTotals[c]?a.yAbsTotals[c]:0)+Math.abs(e),0<=e?r=!0:0>e&&(y=!0),k[c]=k[c]?k[c]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=h?"dateTime":"number"}a.axisY.logarithmic?(g.max=p(g.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(g.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),g.min=p(g.viewPortMin)?
...
!(1>a.dataSeriesIndexes.length))for(var g=a.axisY.dataInfo,b=a.axisX.dataInfo,c,e,h,r,y=!1,I=0;I<a.dataSeriesIndexes.length;I++){var k=this.data[a.dataSeriesIndexes[I]],m=0,n=!1,q=!1,f,d,p;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var z=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?a.axisX.options.minimum:a.axisX.logarithmic?
...
ia("markerSize",c[b].dataPoint,c[b].dataSeries)||8,c[b].distance<=e/2){g=!0;break}for(b=0;b<c.length;b++)g&&"line"!==c[b].dataSeries.type&&"stepLine"!==c[b].dataSeries.type&&"area"!==c[b].dataSeries.type&&"stepArea"!==c[b].dataSeries.type||(a?c[b].distance<=a.distance&&(a=c[b]):a=c[b]);return a};l.prototype.getObjectAtXY=function(a,g,b){var c=null;if(b=this.getDataPointAtXY(a,g,b||!1))c=b.dataSeries.dataPointIds[b.dataPointIndex];else if(u)c=$a(a,g,this._eventManager.ghostCtx);else for(b=0;b<this.legend.items.length;b++){var e=
this.legend.items[b];a>=e.x1&&(a<=e.x2&&g>=e.y1&&g<=e.y2)&&(c=e.id)}return c};l.prototype.getAutoFontSize=nb;l.prototype.resetOverlayedCanvas=function(){this.overlaidCanvasCtx.clearRect(0,0,this.width,this.height)};l.prototype.clearCanvas=mb;l.prototype.attachEvent=function(a){this._events.push(a)};l.prototype._touchEventHandler=function(a){if(a.changedTouches&&this.interactivityEnabled){var g=[],b=a.changedTouches,c=b?b[0]:a,e=null;switch(a.type){case "touchstart":case "MSPointerDown":g=["mousemove",
"mousedown"];this._lastTouchData=Oa(c);this._lastTouchData.time=new Date;break;case "touchmove":case "MSPointerMove":g=["mousemove"];break;case "touchend":case "MSPointerUp":var h=this._lastTouchData&&this._lastTouchData.time?new Date-this._lastTouchData.time:0,g="touchstart"===this._lastTouchEventType||"MSPointerDown"===this._lastTouchEventType||300>h?["mouseup","click"]:["mouseup"];break;default:return}if(!(b&&1<b.length)){e=Oa(c);e.time=new Date;try{var r=e.y-this._lastTouchData.y,h=e.time-this._lastTouchData.time;
...
e&&e.cursor?e.cursor:this._defaultCursor}h=this.plotArea;if(b.x<h.x1||b.x>h.x2||b.y<h.y1||b.y>h.y2){this.toolTip&&this.toolTip.enabled?(this.toolTip.hide(),this.toolTip.dispatchEvent("hidden",{chart:this,toolTip:this.toolTip},this.toolTip)):this.resetOverlayedCanvas();for(h=0;h<this.axisX.length;h++)this.axisX[h].crosshair&&this.axisX[h].crosshair.enabled&&(this.axisX[h].crosshair.hide(),this.axisX[h].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisX[h].options},this.axisX[h].crosshair));
...
this.axisY2[h].crosshair.enabled&&(this.axisY2[h].crosshair.hide(),this.axisY2[h].crosshair.dispatchEvent("hidden",{chart:this,axis:this.axisY2[h].options},this.axisY2[h].crosshair))}this.sessionVariables.mouseX=b.x;this.sessionVariables.mouseY=b.y;this.isDrag&&this.zoomEnabled||!this._eventManager||this._eventManager.mouseEventHandler(a)}}};l.prototype._plotAreaMouseDown=function(a,g){this.isDrag=!0;this.dragStartPoint={x:a,y:g}};l.prototype._plotAreaMouseUp=function(a,g){if(("normal"===this.plotInfo.axisPlacement||
...
a.x1=g.x1,a.x2=g.x2,a.y1=g.y1,a.y2=g.y2,a.width=g.width,a.height=g.height;u||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Ca(a.x1,a.y1,a.x2,a.y2,2)};l.prototype.renderIndexLabels=function(a){var g=a||this.plotArea.ctx,b=this.plotArea,c=0,e=0,h=0,r=e=h=0,y=0,d=c=0,k=0;for(a=0;a<this._indexLabels.length;a++){var m=this._indexLabels[a],n=m.chartType.toLowerCase(),q,f,y=ia("indexLabelFontColor",
m.dataPoint,m.dataSeries),Qa=ia("indexLabelFontSize",m.dataPoint,m.dataSeries),d=ia("indexLabelFontFamily",m.dataPoint,m.dataSeries),k=ia("indexLabelFontStyle",m.dataPoint,m.dataSeries);q=ia("indexLabelFontWeight",m.dataPoint,m.dataSeries);var w=ia("indexLabelBackgroundColor",m.dataPoint,m.dataSeries);f=ia("indexLabelBorderColor",m.dataPoint,m.dataSeries);var h=ia("indexLabelBorderThickness",m.dataPoint,m.dataSeries),e=ia("indexLabelMaxWidth",m.dataPoint,m.dataSeries),r=ia("indexLabelWrap",m.dataPoint,
m.dataSeries),z=ia("indexLabelLineDashType",m.dataPoint,m.dataSeries),s=ia("indexLabelLineColor",m.dataPoint,m.dataSeries),x=p(m.dataPoint.indexLabelLineThickness)?p(m.dataSeries.options.indexLabelLineThickness)?0:m.dataSeries.options.indexLabelLineThickness:m.dataPoint.indexLabelLineThickness,c=0<x?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,v=ia("indexLabelPadding",m.dataPoint,m.dataSeries),l={percent:null,total:null},B=null;if(0<=m.dataSeries.type.indexOf("stacked")||
...
m.dataSeries.indexLabelFormatter(B):m.dataSeries.indexLabel?this.replaceKeywordsWithValue(m.dataSeries.indexLabel,m.dataPoint,m.dataSeries,null,m.indexKeyword):null;if(null!==E&&""!==E){var l=ia("indexLabelPlacement",m.dataPoint,m.dataSeries),B=ia("indexLabelOrientation",m.dataPoint,m.dataSeries),t=ia("indexLabelTextAlign",m.dataPoint,m.dataSeries),A=m.direction,K=m.dataSeries.axisX,M=m.dataSeries.axisY,X=!1,w=new ja(g,{x:0,y:0,maxWidth:e?e:0.5*this.width,maxHeight:r?5*Qa:1.5*Qa,angle:"horizontal"===
B?0:-90,text:E,padding:v,backgroundColor:w,borderColor:f,borderThickness:h,textAlign:t,fontSize:Qa,fontFamily:d,fontWeight:q,fontColor:y,fontStyle:k,textBaseline:"middle"});w.measureText();m.dataSeries.indexLabelMaxWidth=w.maxWidth;if("stackedarea100"===n){if(m.point.x<b.x1||m.point.x>b.x2||m.point.y<b.y1-1||m.point.y>b.y2+1)continue}else if("rangearea"===n||"rangesplinearea"===n){if(m.dataPoint.x<K.viewportMinimum||m.dataPoint.x>K.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<M.viewportMinimum||
Math.min.apply(null,m.dataPoint.y)>M.viewportMaximum)continue}else if(0<=n.indexOf("line")||0<=n.indexOf("area")||0<=n.indexOf("bubble")||0<=n.indexOf("scatter")){if(m.dataPoint.x<K.viewportMinimum||m.dataPoint.x>K.viewportMaximum||m.dataPoint.y<M.viewportMinimum||m.dataPoint.y>M.viewportMaximum)continue}else if(0<=n.indexOf("column")){if(m.dataPoint.x<K.viewportMinimum||m.dataPoint.x>K.viewportMaximum||(0<m.dataPoint.y.length?Math.max.apply(null,m.dataPoint.y):m.cumulativeY?m.cumulativeY:m.dataPoint.y)<
M.viewportMinimum||(0<m.dataPoint.y.length?Math.min.apply(null,m.dataPoint.y):m.cumulativeY?m.cumulativeY:m.dataPoint.y)>M.viewportMaximum)continue}else if("waterfall"===n||"error"===n&&!m.axisSwapped){if(m.dataPoint.x<K.viewportMinimum||m.dataPoint.x>K.viewportMaximum||m.bounds.y1>b.y2||m.bounds.y2<b.y1)continue}else if(0<=n.indexOf("bar")||"error"===n){if(m.dataPoint.x<K.viewportMinimum||m.dataPoint.x>K.viewportMaximum||m.bounds.x1>b.x2||m.bounds.x2<b.x1)continue}else if("candlestick"===n||"ohlc"===
n){if(m.dataPoint.x<K.viewportMinimum||m.dataPoint.x>K.viewportMaximum||Math.max.apply(null,m.dataPoint.y)<M.viewportMinimum||Math.min.apply(null,m.dataPoint.y)>M.viewportMaximum)continue}else if(m.dataPoint.x<K.viewportMinimum||m.dataPoint.x>K.viewportMaximum)continue;r=y=2;"horizontal"===B?(d=w.width,k=w.height):(k=w.width,d=w.height);if("normal"===this.plotInfo.axisPlacement){if(0<=n.indexOf("line")||0<=n.indexOf("area"))l="auto",y=4;else if(0<=n.indexOf("stacked"))"auto"===l&&(l="inside");else if("bubble"===
n||"scatter"===n)l="inside";q=m.point.x-d/2+("horizontal"===B?0:w._lineHeight/2);if("inside"!==l)e=b.y1,h=b.y2,0<A?(f=m.point.y+w._lineHeight/2-k-y-c,f<e&&(f="auto"===l?Math.max(m.point.y,e)+w._lineHeight/2+y+c:e+w._lineHeight/2+y+c,X=f+("horizontal"===B?k-w._lineHeight/2:0)>m.point.y,!X||(0<=n.indexOf("line")||0<=n.indexOf("area"))||(f-=c))):(f=m.point.y+w._lineHeight/2+y+c,f>h-k+w._lineHeight/2-y&&(f="auto"===l?Math.min(m.point.y,h)+w._lineHeight/2-k-y-c:h+w._lineHeight/2-k-y-c,X=f-("horizontal"===
...
B?0:w._lineHeight/2)-r-c,("horizontal"===B?q:q-w._lineHeight/2)<h&&(q="auto"===l?Math.max(m.point.x,h)+("horizontal"===B?0:w._lineHeight/2)+y+c:h+("horizontal"===B?0:w._lineHeight/2)+r,(X=q+d-("horizontal"===B?0:w._lineHeight/2)>m.point.x)&&(q-=c))):(q=m.point.x+("horizontal"===B?0:w._lineHeight/2)+r+c,("horizontal"===B?q:q-w._lineHeight/2)>e-d-r-c&&(q="auto"===l?Math.min(m.point.x,e)-("horizontal"===B?d:d-w._lineHeight/2)-r-c:e-d-r+("horizontal"===B?0:w._lineHeight/2),(X=q-("horizontal"===B?0:w._lineHeight/
...
(X=0<A?f+("horizontal"===B?k-w._lineHeight/2:0)>m.point.y:f-("horizontal"===B?w._lineHeight/2:k)<m.point.y),"bubble"===n||"scatter"===n)&&(q+=w._lineHeight/2-Qa/2);w.x=q;w.y=f;w.render(!0);x&&("inside"!==l&&(0>n.indexOf("bar")&&("error"!==n||!m.axisSwapped)&&m.point.x>b.x1&&m.point.x<b.x2||!X)&&(-1==="ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(n)&&("error"!==n||m.axisSwapped)&&m.point.y>b.y1&&m.point.y<b.y2||!X))&&(g.lineWidth=x,g.strokeStyle=
s?s:"gray",g.setLineDash&&g.setLineDash(J(z,x)),g.beginPath(),g.moveTo(m.point.x,m.point.y),0<=n.indexOf("bar")||"error"===n&&m.axisSwapped?g.lineTo(q+(0<m.direction?0:d)+("vertical"===B?-w._lineHeight/2:0),f+("vertical"===B?-k/2:k/2-w._lineHeight/2)):0<=n.indexOf("column")||"error"===n&&!m.axisSwapped?g.lineTo(q+d/2-("horizontal"===B?0:w._lineHeight/2),f+("vertical"===B?f-k<m.point.y?0:-k:(f-w._lineHeight/2<m.point.y?k:0)-w._lineHeight/2)):0<=n.indexOf("waterfall")?g.lineTo(q+d/2-("horizontal"===
...
for(a=0;a<this._indexLabels.length;a++)m=this._indexLabels[a],w=ia("indexLabelBackgroundColor",m.dataPoint,m.dataSeries),m.dataSeries.indexLabelBackgroundColor=p(w)?u?"transparent":null:w;return g};l.prototype.renderLine=function(a){var g=a.targetCanvasCtx||this.plotArea.ctx,b=u?this._preRenderCtx:g;if(!(0>=a.dataSeriesIndexes.length)){var c=this._eventManager.ghostCtx;b.save();var e=this.plotArea;b.beginPath();b.rect(e.x1,e.y1,e.width,e.height);b.clip();for(var h=[],r,y=0;y<a.dataSeriesIndexes.length;y++){var d=
a.dataSeriesIndexes[y],k=this.data[d];b.lineWidth=k.lineThickness;var m=k.dataPoints,n="solid";if(b.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),n=k.lineDashType,f=J(n,k.lineThickness);b.setLineDash(f)}var p=k.id;this._eventManager.objectMap[p]={objectType:"dataSeries",dataSeriesIndex:d};p=Q(p);c.strokeStyle=p;c.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var p=k._colorSet,w=p=k.lineColor=k.options.lineColor?k.options.lineColor:p[0];b.strokeStyle=p;var z=!0,s=0,x,v;b.beginPath();
...
k.lineDashType))&&(b.stroke(),b.beginPath(),b.moveTo(x,v),w=m[s].lineColor||p,b.strokeStyle=w,b.setLineDash&&(m[s].lineDashType?(n=m[s].lineDashType,b.setLineDash(J(n,k.lineThickness))):(n=k.lineDashType,b.setLineDash(f))));if(0!==m[s].markerSize&&(0<m[s].markerSize||0<k.markerSize)){var E=k.getMarkerProperties(s,x,v,b);h.push(E);B=Q(B);u&&h.push({x:x,y:v,ctx:c,type:E.type,size:E.size,color:B,borderColor:B,borderThickness:E.borderThickness})}(m[s].indexLabel||k.indexLabel||m[s].indexLabelFormatter||
k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[s],dataSeries:k,point:{x:x,y:v},direction:0>m[s].y===a.axisY.reversed?1:-1,color:p})}b.stroke();u&&c.stroke()}}T.drawMarkers(h);u&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
[],r,y=0;y<a.dataSeriesIndexes.length;y++){var d=a.dataSeriesIndexes[y],k=this.data[d];b.lineWidth=k.lineThickness;var m=k.dataPoints,n="solid";if(b.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),n=k.lineDashType,f=J(n,k.lineThickness);b.setLineDash(f)}var p=k.id;this._eventManager.objectMap[p]={objectType:"dataSeries",dataSeriesIndex:d};p=Q(p);c.strokeStyle=p;c.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var p=k._colorSet,w=p=k.lineColor=k.options.lineColor?k.options.lineColor:
...
(c.stroke(),c.beginPath(),c.moveTo(x,v))));r={x:x,y:v};s<m.length-1&&(w!==(m[s].lineColor||p)||n!==(m[s].lineDashType||k.lineDashType))&&(b.stroke(),b.beginPath(),b.moveTo(x,v),w=m[s].lineColor||p,b.strokeStyle=w,b.setLineDash&&(m[s].lineDashType?(n=m[s].lineDashType,b.setLineDash(J(n,k.lineThickness))):(n=k.lineDashType,b.setLineDash(f))));0!==m[s].markerSize&&(0<m[s].markerSize||0<k.markerSize)&&(B=k.getMarkerProperties(s,x,v,b),h.push(B),E=Q(E),u&&h.push({x:x,y:v,ctx:c,type:B.type,size:B.size,
color:E,borderColor:E,borderThickness:B.borderThickness}));(m[s].indexLabel||k.indexLabel||m[s].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:m[s],dataSeries:k,point:{x:x,y:v},direction:0>m[s].y===a.axisY.reversed?1:-1,color:p})}b.stroke();u&&c.stroke()}}T.drawMarkers(h);u&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
...
m[l].x.getTime():m[l].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!x)))if("number"!==typeof m[l].y)0<l&&!x&&(k.connectNullData?c.setLineDash&&(0<v.length&&(k.options.nullDataLineDashType||!m[l-1].lineDashType))&&(v[v.length-1].newLineDashArray=q,n=k.nullDataLineDashType):(g(v),v=[])),x=!0;else{s=a.axisX.convertValueToPixel(s);x=a.axisY.convertValueToPixel(m[l].y);var Ea=k.dataPointIds[l];this._eventManager.objectMap[Ea]={id:Ea,objectType:"dataPoint",dataSeriesIndex:d,
dataPointIndex:l,x1:s,y1:x};v[v.length]={x:s,y:x};l<m.length-1&&(w!==(m[l].lineColor||p)||n!==(m[l].lineDashType||k.lineDashType))&&(w=m[l].lineColor||p,v[v.length-1].newStrokeStyle=w,c.setLineDash&&(m[l].lineDashType?(n=m[l].lineDashType,v[v.length-1].newLineDashArray=J(n,k.lineThickness)):(n=k.lineDashType,v[v.length-1].newLineDashArray=f)));if(0!==m[l].markerSize&&(0<m[l].markerSize||0<k.markerSize)){var B=k.getMarkerProperties(l,s,x,c);r.push(B);Ea=Q(Ea);u&&r.push({x:s,y:x,ctx:e,type:B.type,size:B.size,
color:Ea,borderColor:Ea,borderThickness:B.borderThickness})}(m[l].indexLabel||k.indexLabel||m[l].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:m[l],dataSeries:k,point:{x:s,y:x},direction:0>m[l].y===a.axisY.reversed?1:-1,color:p});x=!1}g(v)}T.drawMarkers(r);u&&(b.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
r=a.axisX.reversed?r+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+m)*n<<0:r-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+m)*n<<0;var z=a.axisX.reversed?r-n<<0:r+n<<0,s;0<=p[h].y?s=k:(s=y,y=k);y>s&&(c=y,y=s,s=c);c=p[h].color?p[h].color:f._colorSet[h%f._colorSet.length];ba(b,a.axisX.reversed?z:r,y,a.axisX.reversed?r:z,s,c,0,null,l&&(a.axisY.reversed?0>p[h].y:0<=p[h].y),(a.axisY.reversed?0<=p[h].y:0>p[h].y)&&l,!1,!1,f.fillOpacity);c=f.dataPointIds[h];this._eventManager.objectMap[c]=
{id:c,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:r,y1:y,x2:z,y2:s};c=Q(c);u&&ba(this._eventManager.ghostCtx,a.axisX.reversed?z:r,y,a.axisX.reversed?r:z,s,c,0,null,!1,!1,!1,!1);(p[h].indexLabel||f.indexLabel||p[h].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:p[h],dataSeries:f,point:{x:r+(z-r)/2,y:0>p[h].y===a.axisY.reversed?y:s},direction:0>p[h].y===a.axisY.reversed?1:-1,bounds:{x1:r,y1:Math.min(y,s),x2:z,y2:Math.max(y,s)},color:c})}}u&&
...
(this.dataPointMinWidth&&m<h)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));n<h&&(n=h);n>m&&(n=m);b.save();u&&this._eventManager.ghostCtx.save();b.beginPath();b.rect(e.x1,e.y1,e.width,e.height);b.clip();u&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(m=0;m<a.dataSeriesIndexes.length;m++){var q=a.dataSeriesIndexes[m],f=this.data[q],p=f.dataPoints;if(0<p.length){var l=5<n&&f.bevelEnabled?
!0:!1;b.strokeStyle="#4572A7 ";for(h=0;h<p.length;h++)if(p[h].getTime?d=p[h].x.getTime():d=p[h].x,!(d<a.axisX.dataInfo.viewPortMin||d>a.axisX.dataInfo.viewPortMax)&&"number"===typeof p[h].y){y=a.axisX.convertValueToPixel(d);r=a.axisY.convertValueToPixel(p[h].y);y=a.axisX.reversed?y+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+m)*n<<0:y-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+m)*n<<0;var z=a.axisX.reversed?y-n<<0:y+n<<0,s;0<=p[h].y?s=k:(s=r,r=k);c=p[h].color?p[h].color:
f._colorSet[h%f._colorSet.length];ba(b,a.axisY.reversed?r:s,a.axisX.reversed?z:y,a.axisY.reversed?s:r,a.axisX.reversed?y:z,c,0,null,l,!1,!1,!1,f.fillOpacity);c=f.dataPointIds[h];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:s,y1:y,x2:r,y2:z};c=Q(c);u&&ba(this._eventManager.ghostCtx,s,a.axisX.reversed?z:y,r,a.axisX.reversed?y:z,c,0,null,!1,!1,!1,!1);(p[h].indexLabel||f.indexLabel||p[h].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",
dataPoint:p[h],dataSeries:f,point:{x:0<=p[h].y?r:s,y:y+(z-y)/2},direction:0>p[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(s,r),y1:y,x2:Math.max(s,r),y2:z},color:c})}}}u&&(g.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
z._colorSet.length];ba(b,a.axisY.reversed?m:t,n,a.axisY.reversed?t:m,v,c,0,null,x,!1,!1,!1,z.fillOpacity);c=z.dataPointIds[k];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:k,x1:t,y1:n,x2:m,y2:v};c=Q(c);u&&ba(this._eventManager.ghostCtx,t,n,m,v,c,0,null,!1,!1,!1,!1);(s[k].indexLabel||z.indexLabel||s[k].indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:s[k],dataSeries:z,point:{x:0<=s[k].y?m:t,y:n+(v-
...
r[c]:0,v=m-B,m=q-B,a.dataSeriesIndexes.length-1===f&&1>=Math.abs(e.x1-v)&&(v=e.x1),r[c]=B+(m-v);c=s[k].color?s[k].color:z._colorSet[k%z._colorSet.length];ba(b,a.axisY.reversed?m:v,n,a.axisY.reversed?v:m,t,c,0,null,x,!1,!1,!1,z.fillOpacity);c=z.dataPointIds[k];this._eventManager.objectMap[c]={id:c,objectType:"dataPoint",dataSeriesIndex:w,dataPointIndex:k,x1:v,y1:n,x2:m,y2:t};c=Q(c);u&&ba(this._eventManager.ghostCtx,v,n,m,t,c,0,null,!1,!1,!1,!1);(s[k].indexLabel||z.indexLabel||s[k].indexLabelFormatter||
...
f._colorSet[w%f._colorSet.length],A=f.lineColor=f.options.lineColor||E,C=A;h.fillStyle=E;h.strokeStyle=A;h.lineWidth=f.lineThickness;b="solid";if(h.setLineDash){var K=J(f.nullDataLineDashType,f.lineThickness);b=f.lineDashType;var M=J(b,f.lineThickness);h.setLineDash(M)}for(var X=!0;w<l.length;w++)if(x=l[w].x.getTime?l[w].x.getTime():l[w].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!f.connectNullData||!X)))if("number"!==typeof l[w].y)f.connectNullData||(X||g)||c(),X=!0;else{z=
a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(l[w].y);g||X?(!g&&f.connectNullData?(h.setLineDash&&(f.options.nullDataLineDashType||b===f.lineDashType&&f.lineDashType!==f.nullDataLineDashType)&&(g=z,b=s,z=m.x,s=m.y,c(),h.moveTo(m.x,m.y),z=g,s=b,B=m,b=f.nullDataLineDashType,h.setLineDash(K)),h.lineTo(z,s),u&&r.lineTo(z,s)):(h.beginPath(),h.moveTo(z,s),u&&(r.beginPath(),r.moveTo(z,s)),B={x:z,y:s}),X=g=!1):(h.lineTo(z,s),u&&r.lineTo(z,s),0==w%250&&c());m={x:z,y:s};w<l.length-1&&(C!==(l[w].lineColor||
A)||b!==(l[w].lineDashType||f.lineDashType))&&(c(),C=l[w].lineColor||A,h.strokeStyle=C,h.setLineDash&&(l[w].lineDashType?(b=l[w].lineDashType,h.setLineDash(J(b,f.lineThickness))):(b=f.lineDashType,h.setLineDash(M))));var Y=f.dataPointIds[w];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:w,x1:z,y1:s};0!==l[w].markerSize&&(0<l[w].markerSize||0<f.markerSize)&&(x=f.getMarkerProperties(w,z,s,h),p.push(x),Y=Q(Y),u&&p.push({x:z,y:s,ctx:r,type:x.type,size:x.size,
color:Y,borderColor:Y,borderThickness:x.borderThickness}));(l[w].indexLabel||f.indexLabel||l[w].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:l[w],dataSeries:f,point:{x:z,y:s},direction:0>l[w].y===a.axisY.reversed?1:-1,color:E})}c();T.drawMarkers(p)}}u&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),h.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&h.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
a.axisY.viewportMinimum:0),t,B=null;b=!1;if(0<l.length){var E=f._colorSet[w%f._colorSet.length],A=f.lineColor=f.options.lineColor||E,C=A;h.fillStyle=E;h.strokeStyle=A;h.lineWidth=f.lineThickness;var K="solid";if(h.setLineDash){var M=J(f.nullDataLineDashType,f.lineThickness),K=f.lineDashType,X=J(K,f.lineThickness);h.setLineDash(X)}for(;w<l.length;w++)if(x=l[w].x.getTime?l[w].x.getTime():l[w].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!f.connectNullData||!b))){var Y=s;"number"!==
typeof l[w].y?(f.connectNullData||(b||g)||c(),b=!0):(z=a.axisX.convertValueToPixel(x),s=a.axisY.convertValueToPixel(l[w].y),g||b?(!g&&f.connectNullData?(h.setLineDash&&(f.options.nullDataLineDashType||K===f.lineDashType&&f.lineDashType!==f.nullDataLineDashType)&&(g=z,b=s,z=m.x,s=m.y,c(),h.moveTo(m.x,m.y),z=g,s=b,B=m,K=f.nullDataLineDashType,h.setLineDash(M)),h.lineTo(z,Y),h.lineTo(z,s),u&&(r.lineTo(z,Y),r.lineTo(z,s))):(h.beginPath(),h.moveTo(z,s),u&&(r.beginPath(),r.moveTo(z,s)),B={x:z,y:s}),b=g=
!1):(h.lineTo(z,Y),u&&r.lineTo(z,Y),h.lineTo(z,s),u&&r.lineTo(z,s),0==w%250&&c()),m={x:z,y:s},w<l.length-1&&(C!==(l[w].lineColor||A)||K!==(l[w].lineDashType||f.lineDashType))&&(c(),C=l[w].lineColor||A,h.strokeStyle=C,h.setLineDash&&(l[w].lineDashType?(K=l[w].lineDashType,h.setLineDash(J(K,f.lineThickness))):(K=f.lineDashType,h.setLineDash(X)))),x=f.dataPointIds[w],this._eventManager.objectMap[x]={id:x,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:w,x1:z,y1:s},0!==l[w].markerSize&&(0<l[w].markerSize||
0<f.markerSize)&&(Y=f.getMarkerProperties(w,z,s,h),p.push(Y),x=Q(x),u&&p.push({x:z,y:s,ctx:r,type:Y.type,size:Y.size,color:x,borderColor:x,borderThickness:Y.borderThickness})),(l[w].indexLabel||f.indexLabel||l[w].indexLabelFormatter||f.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:l[w],dataSeries:f,point:{x:z,y:s},direction:0>l[w].y===a.axisY.reversed?1:-1,color:E}))}c();T.drawMarkers(p)}}u&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),h.globalCompositeOperation=
